...
CREATE TABLE `check_work_attendance` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='考勤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employee` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='员工';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employee` VALUES (18,'aaa','aaa','李四','男',26,'本科','234213423@qq.com','2018-10-22','在职',16),(19,'youke1','12345','游客1','男',26,'硕士','22@qq.com','2018-10-23','离职',24),(20,'test1','test1','张某','男',26,'本科','9999999@qq.com','2018-10-24','在职',22),(21,'test2','test2','小明','男',27,'本科','11@qq.com','2018-10-24','在职',16);
...
INSERT INTO `employeeinfo` VALUES (5,18,-1,-1,-1,-1,18,16),(6,19,-1,-1,-1,-1,19,24),(7,20,-1,-1,-1,-1,19,22),(8,21,-1,-1,-1,-1,18,16);
...
INSERT INTO `go_interview` VALUES (15,'aaa','已查看','已录用'),(16,'youke1','已查看','已录用'),(17,'test1','已查看','已录用'),(18,'test2','已查看','已录用');
...
CREATE TABLE `interview` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1 COMMENT='面试邀请';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `interview` VALUES (7,'aaa',3,'2018-10-26'),(8,'youke1',3,'2018-10-26'),(9,'test2',8,'2018-10-27'),(10,'test1',3,'2018-11-06');
...
CREATE TABLE `reconsider` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='复议';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reconsider` VALUES (1,20,'','2018-10-24 13:40:02'),(2,20,'hhhhhhhhhhhhhhh','2018-10-24 13:41:19');
...
CREATE TABLE `resume` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='简历';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `resume` VALUES (4,'aaa','张三','男',26,'共青团员','17333334455','234213423@qq.com','程序员','6000-7000',19,22,'本科','有有有有有有有有有有有有有有有有有','玩'),(5,'333','猫猫','男',5,'党员','12345678910','333@qq.com','无','6000-7000',19,22,'硕士','啦啦啦啦啦啦啦','看书'),(6,'youke1','游客1','男',33,'共青团员','98765432110','22@qq.com','啦啦啦啦','7000-9000',19,23,'硕士','无','看书'),(7,'test1','张某','男',26,'共青团员','74185296332','9999999@qq.com','程序员','7000-9000',19,22,'硕士','无','看书'),(8,'test2','小明','男',27,'普通群众','17368081234','11@qq.com','会计师','6000-7000',18,16,'本科','无','哈哈');
...
CREATE TABLE `reward` (
  ...
  `time` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='奖赏';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reward` VALUES (11,18,'新入职奖励',200,'2018-10-22'),(12,18,'早退2小时',-40,'2018-10-25'),(13,18,'迟到1小时',-20,'2018-10-26'),(14,18,'早退1小时',-20,'2018-10-26'),(15,18,'早退1小时',-20,'2018-10-29'),(16,18,'迟到3小时',-60,'2018-10-31'),(17,20,'早退5小时',-200,'2018-10-24');
...
CREATE TABLE `visitor` (
  ...
  `password` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='游客';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `visitor` VALUES (3,'bbb','222'),(24,'aaa','111'),(25,'aaa1','111'),(26,'hhh','hhh'),(27,'111','111'),(28,'123','11'),(29,'333','333'),(30,'zxc','zxc'),(31,'youke1','12345'),(32,'test1','test1'),(33,'test2','test2');
...
-- Dump completed on 2018-10-24 15:13:26
